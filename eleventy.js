...
module.exports = function(eleventyConfig) {
  ...
  // RSS FEED
    ...
    eleventyConfig.addFilter('dateToRfc3339', pluginRss.dateRfc3339);
  ...
  eleventyConfig.addShortcode('responsiveImage', function (baseSrc, ext, max, alt, classes, link) {
    const fullBaseSrc = '/assets/images/content/' + baseSrc;
    let sources = '<source media='(min-width: 501px)' srcset='' + fullBaseSrc + '-m.' + ext + ''>';
    if (max !== 'm') {
